document.addEventListener('DOMContentLoaded', () => {
    const translations = {
        en: {
          ...
          aboutMeInfo: 'Hi, I am Rosen Ivanov! I am 17 years old boy from Botevgrad, Bulgaria. I study web programming with django at SoftUni. I want one day to become senior full-stack engineer. I also study programming in programming school. Currently I am a student at NPG po KTS in town Pravets.',
        ...
        bg: {
          ...
          aboutMeInfo: 'Здравейте, аз съм Росен Иванов! Аз съм момче на 17 години от Ботевград, България. Уча уеб програмиране с django в СофтУни. Искам един ден да стана full-stack инженер. Аз също уча програмиране в училище по програмиране. В момента съм ученик в НПГ по КТС гр. Правец.',
